...
export function StatCard({ label, value, color, glowClass, colorHex }: {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[var(--color-border-dark)] bg-[#0A0A0A] p-3 sm:p-5 group transition-all duration-500 hover:border-white/20 h-full flex flex-col justify-center">
